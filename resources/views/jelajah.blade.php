...
@section('content')
    ...
    <form action="{{ route('jelajah') }}" method="GET" x-data="{ showFilters: false }">

        <section class="relative pt-32 pb-12 overflow-hidden">
            <div class="absolute inset-0 z-0">
                <div
                    class="absolute top-20 right-10 w-72 h-72 bg-primary-orange/20 rounded-full blur-3xl animate-pulse-slow">
                </div>
            ...
            <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center space-y-6 mb-12 animate-slide-up">
                    <div
                        class="inline-flex items-center gap-2 px-4 py-2 bg-orange-light dark:bg-orange-900/30 rounded-full">
                    ...
                    <div
                        class="bg-white dark:bg-surface-dark p-2 rounded-2xl shadow-2xl shadow-orange-500/10 max-w-3xl mx-auto">
                        <div class="flex flex-col md:flex-row gap-2">
                            <div class="flex-1 flex items-center px-4 py-3 bg-gray-50 dark:bg-gray-800 rounded-xl group">
                                <span
                                    class="material-symbols-outlined text-primary-orange mr-3 group-hover:scale-110 transition-transform">search</span>
                                <input name="q" value="{{ request('q') }}"
                                    class="bg-transparent border-none w-full text-gray-900 dark:text-white placeholder:text-gray-400 focus:ring-0 p-0"
                                    placeholder="Cari UMKM, produk, atau kategori..." type="text" />
                                @if (request('q'))
                            ...
                            <button type="submit"
                                class="px-6 py-3 bg-gradient-to-r from-primary-orange to-primary-green hover:shadow-lg hover:shadow-orange-500/50 text-white font-bold rounded-xl transition-all transform hover:scale-105 flex items-center justify-center gap-2">
        ...
        <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
            <div class="flex flex-col lg:flex-row gap-8">
                <aside class="w-full lg:w-72 flex-shrink-0">
                    <div class="lg:hidden mb-4">
                        <button type="button" @click="showFilters = !showFilters"
                            class="flex items-center justify-center w-full px-6 py-3 border-2 border-gray-200 dark:border-gray-700 rounded-xl shadow-sm text-sm font-bold text-gray-700 dark:text-gray-200 bg-white dark:bg-surface-dark hover:border-primary-orange transition-all">
                    ...
                    <div class="hidden lg:block space-y-6" :class="showFilters ? 'block' : 'hidden lg:block'">
                        <div
                            class="bg-white dark:bg-surface-dark rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-gray-800">
                            ...
                            <div class="space-y-3">
                                <label
                                    class="flex items-center gap-3 cursor-pointer group p-2 rounded-lg hover:bg-orange-light dark:hover:bg-orange-900/20 transition-all">
                                    <input name="categories[]" value="kuliner"
                                        {{ in_array('kuliner', request('categories', [])) ? 'checked' : '' }}
                                        onchange="this.form.submit()"
                                        class="h-5 w-5 rounded border-gray-300 text-primary-orange focus:ring-primary-orange dark:border-gray-600 dark:bg-gray-800"
                                        type="checkbox" />
                                    <span
                                        class="text-gray-700 dark:text-gray-300 group-hover:text-primary-orange font-medium transition-colors">Kuliner
                                        (F&B)</span>
                                </label>
                                <label
                                    ...
                                    <input name="categories[]" value="fashion"
                                        {{ in_array('fashion', request('categories', [])) ? 'checked' : '' }}
                                        onchange="this.form.submit()"
                                        class="h-5 w-5 rounded border-gray-300 text-primary-green focus:ring-primary-green dark:border-gray-600 dark:bg-gray-800"
                                        type="checkbox" />
                                    <span
                                        class="text-gray-700 dark:text-gray-300 group-hover:text-primary-green font-medium transition-colors">Fashion
                                        & Aksesoris</span>
                                </label>
                                <label
                                    class="flex items-center gap-3 cursor-pointer group p-2 rounded-lg hover:bg-orange-light dark:hover:bg-orange-900/20 transition-all">
                                    <input name="categories[]" value="kerajinan"
                                        {{ in_array('kerajinan', request('categories', [])) ? 'checked' : '' }}
                                        onchange="this.form.submit()"
                                        class="h-5 w-5 rounded border-gray-300 text-primary-orange focus:ring-primary-orange dark:border-gray-600 dark:bg-gray-800"
                                        type="checkbox" />
                                    <span
                                        class="text-gray-700 dark:text-gray-300 group-hover:text-primary-orange font-medium transition-colors">Kerajinan
                                        Tangan</span>
                                </label>
                                <label
                                    class="flex items-center gap-3 cursor-pointer group p-2 rounded-lg hover:bg-green-light dark:hover:bg-green-900/20 transition-all">
                                    <input name="categories[]" value="jasa"
                                        {{ in_array('jasa', request('categories', [])) ? 'checked' : '' }}
                                        onchange="this.form.submit()"
                                        class="h-5 w-5 rounded border-gray-300 text-primary-green focus:ring-primary-green dark:border-gray-600 dark:bg-gray-800"
                                        type="checkbox" />
                                    <span
                                        class="text-gray-700 dark:text-gray-300 group-hover:text-primary-green font-medium transition-colors">Jasa
                                        & Layanan</span>
                                </label>
                                <label
                                    class="flex items-center gap-3 cursor-pointer group p-2 rounded-lg hover:bg-orange-light dark:hover:bg-orange-900/20 transition-all">
                                    <input name="categories[]" value="pertanian"
                                        {{ in_array('pertanian', request('categories', [])) ? 'checked' : '' }}
                                        onchange="this.form.submit()"
                                        class="h-5 w-5 rounded border-gray-300 text-primary-orange focus:ring-primary-orange dark:border-gray-600 dark:bg-gray-800"
                                        type="checkbox" />
                                    <span
                                        class="text-gray-700 dark:text-gray-300 group-hover:text-primary-orange font-medium transition-colors">Agrobisnis</span>
                                </label>
                            </div>
                        </div>
                                ...
                                <select name="location" onchange="this.form.submit()"
                                    ...
                                    @foreach (['Aceh', 'Sumatera Utara', 'Sumatera Barat', 'Riau', 'Jambi', 'Sumatera Selatan', 'Bengkulu', 'Lampung', 'Kep. Bangka Belitung', 'Kep. Riau', 'DKI Jakarta', 'Jawa Barat', 'Jawa Tengah', 'DI Yogyakarta', 'Jawa Timur', 'Banten', 'Bali', 'Nusa Tenggara Barat', 'Nusa Tenggara Timur', 'Kalimantan Barat', 'Kalimantan Tengah', 'Kalimantan Selatan', 'Kalimantan Timur', 'Kalimantan Utara', 'Sulawesi Utara', 'Sulawesi Tengah', 'Sulawesi Selatan', 'Sulawesi Tenggara', 'Gorontalo', 'Sulawesi Barat', 'Maluku', 'Maluku Utara', 'Papua', 'Papua Barat', 'Papua Selatan', 'Papua Tengah', 'Papua Pegunungan', 'Papua Barat Daya'] as $provinsi)
                                        <option value="{{ $provinsi }}"
                                            {{ request('location') == $provinsi ? 'selected' : '' }}>{{ $provinsi }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div
                            ...
                            <div class="space-y-3">
                                <label
                                    class="flex items-center gap-3 cursor-pointer group p-2 rounded-lg hover:bg-amber-50 dark:hover:bg-amber-900/20 transition-all">
                                    <input name="rating" value="" type="radio" onchange="this.form.submit()"
                                        {{ !request('rating') ? 'checked' : '' }}
                                        class="h-5 w-5 border-gray-300 text-amber-500 focus:ring-amber-500 dark:border-gray-600 dark:bg-gray-800" />
                                    <span class="text-sm text-gray-700 dark:text-gray-300 font-medium">Semua Rating</span>
                                </label>
                                <label
                                    class="flex items-center gap-3 cursor-pointer group p-2 rounded-lg hover:bg-amber-50 dark:hover:bg-amber-900/20 transition-all">
                                    <input name="rating" value="lt_4" type="radio" onchange="this.form.submit()"
                                        {{ request('rating') == 'lt_4' ? 'checked' : '' }}
                                        class="h-5 w-5 border-gray-300 text-amber-500 focus:ring-amber-500 dark:border-gray-600 dark:bg-gray-800" />
                                    <div class="flex items-center text-amber-400">
                                        ...
                                        <span class="text-sm text-gray-700 dark:text-gray-300 ml-2 font-medium">Rating
                                            1-3</span>
                                    </div>
                                </label>
                                <label
                                    class="flex items-center gap-3 cursor-pointer group p-2 rounded-lg hover:bg-amber-50 dark:hover:bg-amber-900/20 transition-all">
                                    <input name="rating" value="4" type="radio" onchange="this.form.submit()"
                ...
                <div class="flex-1">
                    <div
                        class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8 bg-white dark:bg-surface-dark p-6 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-800">
                        <div class="flex items-center gap-2">
                            <p class="text-gray-600 dark:text-gray-300 text-base">
                                Menampilkan <span
                                    class="font-bold text-primary-orange text-lg">{{ $umkms->count() }}</span> dari
                        ...
                        <div class="flex items-center gap-3 w-full sm:w-auto">
                            ...
                            <div class="relative w-full sm:w-56">
                                <select name="sort" onchange="this.form.submit()"
                                    class="block w-full px-4 py-3 text-sm border-gray-200 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-primary-orange focus:border-transparent rounded-xl bg-gray-50 dark:bg-gray-800 dark:text-white font-medium cursor-pointer">
                                    <option {{ request('sort') == 'Paling Relevan' ? 'selected' : '' }}>Paling Relevan
                                    </option>
                                    <option {{ request('sort') == 'Terbaru' ? 'selected' : '' }}>Terbaru</option>
                                    <option {{ request('sort') == 'Terlama' ? 'selected' : '' }}>Terlama</option>
                                    <option {{ request('sort') == 'Rating Tertinggi' ? 'selected' : '' }}>Rating Tertinggi
                                    </option>
                                    <option {{ request('sort') == 'Rating Terendah' ? 'selected' : '' }}>Rating Terendah
                                    </option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                                ...
                                <div class="p-6 flex flex-col flex-1">
                                    ...
                                    <div
                                        ...
                                        <div class="flex flex-col">
                                            <span class="text-xs text-gray-500 dark:text-gray-400 font-medium">Mulai
                                                dari</span>
                        ...
                        @empty
                            <div class="col-span-full text-center py-12">
                                ...
                                <p class="text-gray-500 dark:text-gray-400">Coba ubah filter atau kata kunci pencarian
                                    Anda.</p>
                            </div>
                        @endforelse
                    </div>
