            ...
            <div class="bg-white dark:bg-surface-dark p-2 rounded-2xl shadow-2xl shadow-orange-500/10 max-w-3xl mx-auto">
                <div class="flex flex-col md:flex-row gap-2">
                    <div class="flex-1 flex items-center px-4 py-3 bg-gray-50 dark:bg-gray-800 rounded-xl group">
                        ...
                        <input name="q" value="{{ request('q') }}" class="bg-transparent border-none w-full text-gray-900 dark:text-white placeholder:text-gray-400 focus:ring-0 p-0" placeholder="Cari UMKM, produk, atau kategori..." type="text" />
                        @if(request('q'))
                            <a href="{{ route('jelajah') }}" class="ml-2 text-gray-400 hover:text-red-500 transition-colors" title="Hapus pencarian">
            ...
            <div class="hidden lg:block space-y-6" :class="showFilters ? 'block' : 'hidden lg:block'">
                <div class="bg-white dark:bg-surface-dark rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-gray-800">
                    ...
                    <div class="space-y-3">
                        <label class="flex items-center gap-3 cursor-pointer group p-2 rounded-lg hover:bg-orange-light dark:hover:bg-orange-900/20 transition-all">
                            <input name="categories[]" value="kuliner" {{ in_array('kuliner', request('categories', [])) ? 'checked' : '' }} onchange="this.form.submit()" class="h-5 w-5 rounded border-gray-300 text-primary-orange focus:ring-primary-orange dark:border-gray-600 dark:bg-gray-800" type="checkbox" />
                        ...
                        <label class="flex items-center gap-3 cursor-pointer group p-2 rounded-lg hover:bg-green-light dark:hover:bg-green-900/20 transition-all">
                            <input name="categories[]" value="fashion" {{ in_array('fashion', request('categories', [])) ? 'checked' : '' }} onchange="this.form.submit()" class="h-5 w-5 rounded border-gray-300 text-primary-green focus:ring-primary-green dark:border-gray-600 dark:bg-gray-800" type="checkbox" />
                        ...
                        <label class="flex items-center gap-3 cursor-pointer group p-2 rounded-lg hover:bg-orange-light dark:hover:bg-orange-900/20 transition-all">
                            <input name="categories[]" value="kerajinan" {{ in_array('kerajinan', request('categories', [])) ? 'checked' : '' }} onchange="this.form.submit()" class="h-5 w-5 rounded border-gray-300 text-primary-orange focus:ring-primary-orange dark:border-gray-600 dark:bg-gray-800" type="checkbox" />
                        ...
                        <label class="flex items-center gap-3 cursor-pointer group p-2 rounded-lg hover:bg-green-light dark:hover:bg-green-900/20 transition-all">
                            <input name="categories[]" value="jasa" {{ in_array('jasa', request('categories', [])) ? 'checked' : '' }} onchange="this.form.submit()" class="h-5 w-5 rounded border-gray-300 text-primary-green focus:ring-primary-green dark:border-gray-600 dark:bg-gray-800" type="checkbox" />
                        ...
                        <label class="flex items-center gap-3 cursor-pointer group p-2 rounded-lg hover:bg-orange-light dark:hover:bg-orange-900/20 transition-all">
                            <input name="categories[]" value="pertanian" {{ in_array('pertanian', request('categories', [])) ? 'checked' : '' }} onchange="this.form.submit()" class="h-5 w-5 rounded border-gray-300 text-primary-orange focus:ring-primary-orange dark:border-gray-600 dark:bg-gray-800" type="checkbox" />
                ...
                <div class="bg-white dark:bg-surface-dark rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-gray-800">
                    ...
                    <div class="relative mb-4">
                        ...
                        <select name="location" onchange="this.form.submit()" class="block w-full pl-10 pr-4 py-3 text-base border-gray-200 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-primary-green focus:border-transparent rounded-xl dark:bg-gray-800 dark:text-white font-medium">
                            <option {{ request('location') == 'Semua Lokasi' ? 'selected' : '' }}>Semua Lokasi</option>
                            <option {{ request('location') == 'Jakarta Selatan' ? 'selected' : '' }}>Jakarta Selatan</option>
                            <option {{ request('location') == 'Jakarta Pusat' ? 'selected' : '' }}>Jakarta Pusat</option>
                ...
                <div class="group bg-white dark:bg-surface-dark rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 dark:border-gray-800">
                    ...
                    <div class="p-6">
                        ...
                        <div class="pt-4 border-t border-gray-100 dark:border-gray-800 flex items-center justify-between">
                            ...
                            <a class="text-sm font-bold text-primary-orange hover:text-orange-dark flex items-center gap-1 group/link" href="{{ route('umkm.detail', ['id' => $umkm->id]) }}">
                                Lihat Detail
