            ...
            <div class="w-full md:w-1/2 h-full overflow-y-auto custom-scroll p-6 md:p-10">
                ...
                <div class="relative my-6">
                    ...
                    <div class="relative flex justify-center text-xs"><span
                            class="px-3 bg-white dark:bg-gray-800 text-gray-500 font-medium">atau daftar dengan</span>
                    </div>
                </div>

                <div class="grid grid-cols-3 gap-3">
                    <a href="{{ route('auth.google') }}"
                        class="py-2.5 px-4 bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 border border-gray-200 dark:border-gray-600 rounded-xl transition-all flex items-center justify-center">
