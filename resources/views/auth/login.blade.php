...
<body class="bg-gray-100 dark:bg-gray-900 font-display h-screen w-screen overflow-hidden flex items-center justify-center relative">
    ...
    <div class="w-full h-full p-4 md:p-6 flex items-center justify-center">
        ...
        <div class="w-full max-w-5xl h-full md:h-[90vh] bg-white dark:bg-gray-800 rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
            ...
            <div class="w-full md:w-1/2 h-full overflow-y-auto custom-scroll p-8 md:p-12">
                ...
                <div class="mb-6">
                    <div class="inline-flex items-center justify-center size-12 bg-orange-50 dark:bg-orange-900/30 rounded-2xl">
                ...
                <form action="#" method="POST" class="space-y-5">
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <a href="#" class="text-xs font-bold text-primary-orange hover:underline">Lupa Password?</a>
                        </div>
                        <div class="relative">
                ...
                <div class="relative my-6">
                    ...
                    <div class="relative flex justify-center text-xs">
                        <span class="px-3 bg-white dark:bg-gray-800 text-gray-500 font-medium">atau lanjutkan dengan</span>
                    </div>
                </div>

                <div class="grid grid-cols-3 gap-3">
                    <button class="py-3 px-4 bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 border border-gray-200 dark:border-gray-600 rounded-xl transition-all flex items-center justify-center">
                ...
                <div class="text-center pt-4">
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        Belum punya akun? <a href="{{ route('register') }}"
                            class="font-bold text-primary-orange hover:text-orange-600 transition-colors">Daftar Sekarang</a>
                    </p>
                </div>
            </div>
